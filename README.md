...
- Implements RV32I ISA as defined in the [RISC-V unprivileged ISA manual](https://github.com/riscv/riscv-isa-manual/releases/download/Ratified-IMAFDQC/riscv-spec-20191213.pdf).

- Most of the instructions of the RV32I base integer ISA are implemented.

- Simple 2-stage pipe-lined architecture, optimised for small FPGAs.
